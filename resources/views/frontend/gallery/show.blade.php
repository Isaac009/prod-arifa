                ...
                <div class="col-xl-9 col-lg-8 col-12">
                    <div class="post-wrapper blog-details">
                        <div class="single-blog">
                            ...
                            <div class="post-meta">
                                <h5 class="title">{{ $photo->event_title }}</h5>
                                <p>{!! $photo->description !!}</p>
                                <div class="mark-text">
                                    <div class="row">
                                        <div class="col-md-5"><img src="{{ asset('front-resources/images/blog/13.jpg') }}" alt=""></div>
                                        <div class="col-md-7">
                        ...
                        <div class="row">
                            <div class="related-post-slider">
                                <div class="item">
                                    <div class="single-blog">
                                        <div class="image-box">
                                            <img src="{{ asset('front-resources/images/blog/14.jpg') }}" alt="">
                                ...
                                <div class="item">
                                    <div class="single-blog">
                                        <div class="image-box">
                                            <img src="{{ asset('front-resources/images/blog/15.jpg') }}" alt="">
                                ...
                                <div class="item">
                                    <div class="single-blog">
                                        <div class="image-box">
                                            <img src="{{ asset('front-resources/images/blog/16.jpg') }}" alt="">
                    ...
                    <div class="inner-box comment-area">
                        ...
                        <div class="single-comment clearfix">
                            <img src="{{ asset('front-resources/images/blog/17.jpg') }}" alt="" class="float-left">
